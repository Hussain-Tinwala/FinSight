...
def prepare_data_for_routing(file_name="final_evaluated_billing.csv"):
    ...
    if best_model == 'Prophet':
        ...
        for step in range(1, horizon + 1):
            ...
            forecast_rows.append({
                ...
                'lower_bound': max(0, pred - (1.645 * residual_std)), 
...
if __name__ == "__main__":
    ...
    output_path = os.path.join(DATA_DIR, "production_forecast.csv")
